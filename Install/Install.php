...
namespace Apps\Fintech\Packages\Etf\Categories\Install;

use Apps\Fintech\Packages\Etf\Categories\Install\Schema\EtfCategories;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_fintech_etf_categories'  => [
                    'schema'        => new EtfCategories,
                    'model'         => new AppsFintechEtfCategories
                ],
            ];
